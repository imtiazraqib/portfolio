...
export const Header = () => {
  ...
  return (
    <>
      <Flex className={styles.mask} position="fixed" zIndex={9} fillWidth minHeight="80" justifyContent="center"></Flex>
      <Flex
        ...
        <Flex fillWidth justifyContent="center">
          <Flex
            ...
            <Flex gap="4" textVariant="body-default-s">
              ...
              {routes["/about"] && (
                <ToggleButton prefixIcon="person" href={`/${params?.locale}/about`} selected={pathname === "/about"}>
                  <Flex paddingX="2" hide="s">
                    {about.label}
                  </Flex>
                </ToggleButton>
